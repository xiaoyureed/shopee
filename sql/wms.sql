...
) ENGINE = InnoDB AUTO_INCREMENT = 1294091510089007107 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '采购信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wms_ware_info`  (
                                  ...
                                  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1293849035797712898 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '仓库信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wms_ware_order_task`  (
                                        ...
                                        PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '库存工作单' ROW_FORMAT = Dynamic;
