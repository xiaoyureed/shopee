package io.github.xiaoyureed.shopeecommon.util;
...
public final class StringUtils {
    ...
    public static String genRandomJianHan(int len) {
    ...
    public static String genChineseNameJianHan(boolean simple, int len) {
        String[] surName = {
