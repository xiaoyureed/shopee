 ...
 */
@RestController
@RequestMapping("shopeecoupon/spubounds")
public class SpuBoundsController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("shopeecoupon:spubounds:list")
    ...
    //@RequiresPermissions("shopeecoupon:spubounds:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("shopeecoupon:spubounds:save")
    ...
    //@RequiresPermissions("shopeecoupon:spubounds:update")
    ...
    //@RequiresPermissions("shopeecoupon:spubounds:delete")
