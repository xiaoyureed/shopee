 ...
 */
@RestController
@RequestMapping("shopeecoupon/skufullreduction")
public class SkuFullReductionController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("shopeecoupon:skufullreduction:list")
    ...
    //@RequiresPermissions("shopeecoupon:skufullreduction:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("shopeecoupon:skufullreduction:save")
    ...
    //@RequiresPermissions("shopeecoupon:skufullreduction:update")
    ...
    //@RequiresPermissions("shopeecoupon:skufullreduction:delete")
