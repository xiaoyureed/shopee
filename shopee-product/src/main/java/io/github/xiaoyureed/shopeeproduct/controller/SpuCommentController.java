 ...
 */
@RestController
@RequestMapping("shopeeproduct/spucomment")
public class SpuCommentController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("shopeeproduct:spucomment:list")
    ...
    //@RequiresPermissions("shopeeproduct:spucomment:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("shopeeproduct:spucomment:save")
    ...
    //@RequiresPermissions("shopeeproduct:spucomment:update")
    ...
    //@RequiresPermissions("shopeeproduct:spucomment:delete")
