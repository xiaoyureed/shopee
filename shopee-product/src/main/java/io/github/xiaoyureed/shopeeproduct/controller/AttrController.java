 ...
 */
@RestController
@RequestMapping("shopeeproduct/attr")
public class AttrController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("shopeeproduct:attr:list")
    ...
    //@RequiresPermissions("shopeeproduct:attr:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("shopeeproduct:attr:save")
    ...
    //@RequiresPermissions("shopeeproduct:attr:update")
    ...
    //@RequiresPermissions("shopeeproduct:attr:delete")
