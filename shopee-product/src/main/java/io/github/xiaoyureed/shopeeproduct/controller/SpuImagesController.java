 ...
 */
@RestController
@RequestMapping("shopeeproduct/spuimages")
public class SpuImagesController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("shopeeproduct:spuimages:list")
    ...
    //@RequiresPermissions("shopeeproduct:spuimages:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("shopeeproduct:spuimages:save")
    ...
    //@RequiresPermissions("shopeeproduct:spuimages:update")
    ...
    //@RequiresPermissions("shopeeproduct:spuimages:delete")
