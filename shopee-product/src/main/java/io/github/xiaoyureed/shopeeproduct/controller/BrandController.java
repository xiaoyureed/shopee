 ...
 */
@RestController
@RequestMapping("shopeeproduct/brand")
public class BrandController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("shopeeproduct:brand:list")
    ...
    //@RequiresPermissions("shopeeproduct:brand:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("shopeeproduct:brand:save")
    ...
    //@RequiresPermissions("shopeeproduct:brand:update")
    ...
    //@RequiresPermissions("shopeeproduct:brand:delete")
